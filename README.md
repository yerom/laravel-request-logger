...
[![Latest Stable Version](https://poser.pugx.org/yerom/laravel-request-logger/v/stable.svg)](https://packagist.org/packages/yerom/laravel-request-logger) [![Total Downloads](https://poser.pugx.org/prettus/laravel-request-logger/downloads.svg)](https://packagist.org/packages/prettus/laravel-request-logger) [![Latest Unstable Version](https://poser.pugx.org/prettus/laravel-request-logger/v/unstable.svg)](https://packagist.org/packages/prettus/laravel-request-logger) [![License](https://poser.pugx.org/prettus/laravel-request-logger/license.svg)](https://packagist.org/packages/prettus/laravel-request-logger)
...
Add `yerom/laravel-request-logger` to the "require" section of your `composer.json` file.

```json
	"yerom/laravel-request-logger": "1.1.*"
```
